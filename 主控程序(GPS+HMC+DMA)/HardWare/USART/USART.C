...
//    UART_ITConfig(UART1, UART_IT_TXIEN|UART_IT_RXIEN, ENABLE);
    UART_Cmd(UART1, ENABLE);
	  ...
	  UART_ITConfig(UART1, UART_IT_RXIEN, ENABLE);
		...
		NVICinitStucture.NVIC_IRQChannel									=UART1_IRQn;//中断通道，选择串口中断
		NVICinitStucture.NVIC_IRQChannelPreemptionPriority=3;//配置中断优先级
		NVICinitStucture.NVIC_IRQChannelCmd								=ENABLE;//使能打开
		NVICinitStucture.NVIC_IRQChannelSubPriority				=3;//配置中断子优先级
