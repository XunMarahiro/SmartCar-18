...
void TIM3_PWM(int arr,int psc){
	...
	GPIO_InitTypeDef GPIO_Config;
	GPIO_Config.GPIO_Mode=GPIO_Mode_AF_PP;
	GPIO_Config.GPIO_Pin=GPIO_Pin_6|GPIO_Pin_7|GPIO_Pin_8;
	GPIO_Config.GPIO_Speed=GPIO_Speed_50MHz;
	GPIO_Init(GPIOC,&GPIO_Config);
	
	GPIO_PinAFConfig(GPIOC,GPIO_PinSource6,GPIO_AF_1);//CH3
	GPIO_PinAFConfig(GPIOC,GPIO_PinSource7,GPIO_AF_1);//CH2
	GPIO_PinAFConfig(GPIOC,GPIO_PinSource8,GPIO_AF_1);//CH1下桥
