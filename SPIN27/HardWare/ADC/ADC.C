...
void ADC_User_Init(){
	...
	ADC_Config.ADC_PRESCARE=ADC_PCLK2_PRESCARE_10;
	ADC_Config.ADC_Mode=ADC_Mode_Continuous_Scan;
	//ADC_Config.ADC_ExternalTrigConv=ADC_ExternalTrigShiftTime_512_Cycles;
...
float Get_ADC_vale(){//取十次平均值
    ...
    puiADData = ADC_GetConversionValue(ADC1)+puiADData;   
		return puiADData/4096*ADC_Vref*ADC_Gain;
}