...
I2C_Write_REG(HMC5983,0x00,0xFC);
I2C_Write_REG(HMC5983,0x01,0xE0);
...
//		printf("x_real=%d\r\n",x_real);
//		printf("y_real=%d\r\n",y_real);
		return rectangle(y_real,x_real);
	}
}